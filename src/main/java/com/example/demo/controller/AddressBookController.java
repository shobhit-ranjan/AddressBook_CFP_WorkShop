...
public class AddressBookController {
	...
	/**
	 * we will get the address of the person who is id is matched;
	 * as an sno;
	 * the response will be returned as responce dto
	 */
	...
	/**
	 * we will get the complete list of address we have
	 * and that saved and returned responce dto
	 */
	@GetMapping("/")
	...
	/**
	 * we take the id ie sno from the user and detete it
	 * the remaing list will be show will the deleted message
	 */
	 ...
	 * DATA will be added in body in json format and will be saved in the list
	 */
